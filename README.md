...
To gain the access to sEEG datasets, please download and carefully fill out the [license agreement](./image/seeg application file.pdf), and send it to the designated email address. The person in charge will review your application and inform you of the data download procedure.
